...
<title>北京建行MISPOST测试页面</title>
</head>
<body>
	<div id="topay">
		<form id='payform' name='payform'
			action='http://192.168.220.35:8880/ipay/pay/20012' method='post' target='_self'>
			<table>
				<tr>
					<td>用户ID</td>
				...
				<tr>
					<td>用户名</td>
					<td><input type='text' name='username' value='shaochangfu' maxlength="30"/>
				</tr>
				<tr>
					<td>商户订单号(由商户生成)</td>
					<td><input type='text' name='corderid'  maxlength="20"/></td>
				</tr>
				<tr>
					<td>商品ID</td>
				...
				<tr>
					...
					<td><input type='text' name='fronturl'
						value='http://www.baidu.com?1=1' maxlength="200"/>
				</tr>
				<tr>
					<td>通知商户的服务器端地址</td>
				...
				<tr>
					<td>公司标识</td>
					<td><input type='text' name='companyid' value='350001' maxlength="10"/>
				</tr>
				<tr>
					<td>终端标识</td>
