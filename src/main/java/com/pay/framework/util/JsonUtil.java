...
public class JsonUtil {
	...
	public static void main(String[] args) throws Exception {
		// 准备数据
		// List<Lecard> list = new ArrayList<Lecard>();
		// Lecard lecard = new Lecard();
		// lecard.setBatch("batch");
		// lecard.setCardNumber("123456");
		// list.add(lecard);
		// Lecard lecard1 = new Lecard();
		// lecard1.setBatch("batch1");
		// lecard1.setCardNumber("98744");
		// list.add(lecard1);
		// // 实体转JSON字符串
		// String json = beanToJson(list);
		...
		System.out.println(jsonObject.get("adf"));
	}
}
